        ...
        <section class="">
          <div class="grid max-w-7xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
              <h1
                class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-text-dark"
              >
          ...
          <div class="py-8 px-4 mx-auto max-w-7xl sm:py-16 lg:px-6">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
              <div>
                ...
                >
                  <svg
                    class="w-5 h-5 text-dark lg:w-6 lg:h-6"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg"
                  >
          ...
          >
            <div class="font-light text-gray-600 sm:text-lg">
              ...
              <p class="mb-4">
                ...
                el bienestar de las personas. Por eso, nos esforzamos por crear una plataforma de
                pago digital que facilite el acceso al transporte público y ofrezca una experiencia
