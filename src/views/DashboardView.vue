...
<template>
  ...
  >
    <div
      class="w-full h-full min-h-[calc(100vh-2rem)] bg- rounded-3xl shadow-sm border border-gray-200 p-6 md:p-10"
    >
      <HeaderComponent />
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-black">Diseñado para facilitar el servicio público</h2>
          <p class="text-gray-800 sm:text-xl dark:text-grey-600">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-black">Marketing</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-black">Legal</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-black">Business Automation</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-black">Finance</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-black">Enterprise Design</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-black">Operations</h3>
